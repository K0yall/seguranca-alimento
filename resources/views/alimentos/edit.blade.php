...
<div class="max-w-4xl mx-auto">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Editar Alimento</h1>
        <p class="text-gray-600 mt-2">Atualize os valores nutricionais baseados em 1kg (1000g) do alimento</p>
    </div>

    <form action="{{ route('alimentos.update', $alimento) }}" method="POST" class="bg-white rounded-xl shadow-lg p-8">
        @csrf
        @method('PUT')
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" step="0.01" id="calorias" name="calorias" value="{{ old('calorias', $alimento->calorias) }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                </div>
                <div>
                    <label for="carboidratos" class="block text-sm font-medium text-gray-700 mb-2">Carboidratos (g)</label>
                    <input type="number" step="0.01" id="carboidratos" name="carboidratos" value="{{ old('carboidratos', $alimento->carboidratos) }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                </div>
                <div>
                    <label for="proteinas" class="block text-sm font-medium text-gray-700 mb-2">Proteínas (g)</label>
                    <input type="number" step="0.01" id="proteinas" name="proteinas" value="{{ old('proteinas', $alimento->proteinas) }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                </div>
                <div>
                    <label for="gorduras_totais" class="block text-sm font-medium text-gray-700 mb-2">Gorduras Totais (g)</label>
                    <input type="number" step="0.01" id="gorduras_totais" name="gorduras_totais" value="{{ old('gorduras_totais', $alimento->gorduras_totais) }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                </div>
            </div>
        </div>
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" step="0.01" id="gorduras_saturadas" name="gorduras_saturadas" value="{{ old('gorduras_saturadas', $alimento->gorduras_saturadas) }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                </div>
                <div>
                    <label for="gorduras_trans" class="block text-sm font-medium text-gray-700 mb-2">Gorduras Trans (g)</label>
                    <input type="number" step="0.01" id="gorduras_trans" name="gorduras_trans" value="{{ old('gorduras_trans', $alimento->gorduras_trans) }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                </div>
            </div>
        </div>
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" step="0.01" id="fibra" name="fibra" value="{{ old('fibra', $alimento->fibra) }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                </div>
                <div>
                    <label for="acucares" class="block text-sm font-medium text-gray-700 mb-2">Açúcares (g)</label>
                    <input type="number" step="0.01" id="acucares" name="acucares" value="{{ old('acucares', $alimento->acucares) }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                </div>
            </div>
        </div>
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div>
                    ...
                    <input type="number" step="0.01" id="sodio" name="sodio" value="{{ old('sodio', $alimento->sodio) }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                </div>
                <div>
                    <label for="calcio" class="block text-sm font-medium text-gray-700 mb-2">Cálcio (mg)</label>
                    <input type="number" step="0.01" id="calcio" name="calcio" value="{{ old('calcio', $alimento->calcio) }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                </div>
                <div>
                    <label for="ferro" class="block text-sm font-medium text-gray-700 mb-2">Ferro (mg)</label>
                    <input type="number" step="0.01" id="ferro" name="ferro" value="{{ old('ferro', $alimento->ferro) }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                </div>
                <div>
                    <label for="potassio" class="block text-sm font-medium text-gray-700 mb-2">Potássio (mg)</label>
                    <input type="number" step="0.01" id="potassio" name="potassio" value="{{ old('potassio', $alimento->potassio) }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                </div>
                <div>
                    <label for="vitamina_c" class="block text-sm font-medium text-gray-700 mb-2">Vitamina C (mg)</label>
                    <input type="number" step="0.01" id="vitamina_c" name="vitamina_c" value="{{ old('vitamina_c', $alimento->vitamina_c) }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                </div>
            </div>
        </div>
